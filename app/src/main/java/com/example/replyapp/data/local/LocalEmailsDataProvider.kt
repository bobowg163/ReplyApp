...
import com.example.replyapp.data.EmailAttachment
import com.example.replyapp.data.MailboxType

/*
项目:ReplyApp
包名：com.example.replyapp.data.local
作者: bobo
发布日期及时间: 2025/2/6  10:13
*/
object LocalEmailsDataProvider {
    ...
    fun create ():Email{
        return Email(
            ...
            body = "I would like to invite everyone to attend the monthly hosting party."
        )
    }
